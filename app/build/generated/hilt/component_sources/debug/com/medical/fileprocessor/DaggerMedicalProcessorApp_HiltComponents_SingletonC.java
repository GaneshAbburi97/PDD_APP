...
import com.medical.fileprocessor.repository.FirebaseAuthRepository;
...
import com.medical.fileprocessor.viewmodel.AuthViewModel_HiltModules;
...
public final class DaggerMedicalProcessorApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MedicalProcessorApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>of(LazyClassKeyProvider.com_medical_fileprocessor_viewmodel_AuthViewModel, AuthViewModel_HiltModules.KeyModule.provide(), LazyClassKeyProvider.com_medical_fileprocessor_viewmodel_ResultViewModel, ResultViewModel_HiltModules.KeyModule.provide(), LazyClassKeyProvider.com_medical_fileprocessor_viewmodel_UploadViewModel, UploadViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_medical_fileprocessor_viewmodel_AuthViewModel = "com.medical.fileprocessor.viewmodel.AuthViewModel";
      ...
      @KeepFieldType
      AuthViewModel com_medical_fileprocessor_viewmodel_AuthViewModel2;
  ...
  private static final class ViewModelCImpl extends MedicalProcessorApp_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>of(LazyClassKeyProvider.com_medical_fileprocessor_viewmodel_AuthViewModel, ((Provider) authViewModelProvider), LazyClassKeyProvider.com_medical_fileprocessor_viewmodel_ResultViewModel, ((Provider) resultViewModelProvider), LazyClassKeyProvider.com_medical_fileprocessor_viewmodel_UploadViewModel, ((Provider) uploadViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.medical.fileprocessor.viewmodel.AuthViewModel 
          return (T) new AuthViewModel(singletonCImpl.firebaseAuthRepositoryProvider.get());

          case 1: // com.medical.fileprocessor.viewmodel.ResultViewModel 
          return (T) new ResultViewModel(singletonCImpl.processRepositoryImplProvider.get());

          case 2: // com.medical.fileprocessor.viewmodel.UploadViewModel 
          return (T) new UploadViewModel(singletonCImpl.firebaseStorageRepositoryProvider.get(), singletonCImpl.processRepositoryImplProvider.get(), singletonCImpl.firebaseAuthRepositoryProvider.get(), ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
  ...
  private static final class SingletonCImpl extends MedicalProcessorApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideFirebaseAuthInterceptorProvider = DoubleCheck.provider(new SwitchingProvider<FirebaseAuthInterceptor>(singletonCImpl, 7));
      ...
      this.provideFirebaseFirestoreProvider = DoubleCheck.provider(new SwitchingProvider<FirebaseFirestore>(singletonCImpl, 9));
      this.firestoreJobRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<FirestoreJobRepository>(singletonCImpl, 8));
      this.processRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<ProcessRepositoryImpl>(singletonCImpl, 2));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.medical.fileprocessor.repository.FirebaseAuthRepository 
          return (T) new FirebaseAuthRepository(singletonCImpl.provideFirebaseAuthProvider.get());

          case 1: // com.google.firebase.auth.FirebaseAuth 
          return (T) FirebaseModule_ProvideFirebaseAuthFactory.provideFirebaseAuth();

          case 2: // com.medical.fileprocessor.repository.ProcessRepositoryImpl 
          ...
          case 3: // com.medical.fileprocessor.network.ApiService 
          ...
          case 7: // com.medical.fileprocessor.network.FirebaseAuthInterceptor 
          ...
          case 8: // com.medical.fileprocessor.repository.FirestoreJobRepository 
          return (T) new FirestoreJobRepository(singletonCImpl.provideFirebaseFirestoreProvider.get());

          case 9: // com.google.firebase.firestore.FirebaseFirestore 
